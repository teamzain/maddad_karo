...
<p style={styles.subtitle} className="subtitle-text">
  Explore the moments that matter — real stories, heartfelt connections, and the impact of your generosity in action. Every photo is a glimpse into lives touched through Maddad Karo.
</p>
